 ...
 */
public class NetworkCommunityTestSet extends BasicTestSet {

    static Logger log = Logger.getLogger(NetworkCommunityTestSet.class);

    public NetworkCommunityTestSet() {
        super();
    }
    ...
    public void test(String remoteParams) {
