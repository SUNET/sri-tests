...
public class CreateEquipmentandcables extends BasicTestSet {

    static Logger log = Logger.getLogger(CreateEquipmentandcables.class);

    public CreateEquipmentandcables() {
        super();
    }
