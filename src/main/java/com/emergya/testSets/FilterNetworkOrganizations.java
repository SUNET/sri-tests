 ...
 */
public class FilterNetworkOrganizations extends BasicTestSet {

    static Logger log = Logger.getLogger(FilterNetworkOrganizations.class);

    public FilterNetworkOrganizations() {
        super();
    }
